...
def main():
    while True:
        ...
        routes = {
            ...
            "อ.นาดี": {"อ.ประจันตคาม":74,"สวนลุงบิน":35, "จิบกาเเฟ เเลเขา":35,"ผางามเเคมป์ปิ้ง":35,"เเคมป์ปิ้งวิว วังน้ำเขียว":44,"อ.เมืองปราจีนบุรี":68,"นํ้าตกเขาอีโต้":73},
            ...
            "บ้านริมน้ำ ณ บางเเตน": { "อ.บ้านสร้าง":13,"อ.เมืองปราจีนบุรี":41}
        }
